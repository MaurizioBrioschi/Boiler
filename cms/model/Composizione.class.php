<?php
/**
 * Concrete class per le composizioni di mobilitare
 */
class Composizione extends ProdottoAbstract
{
    ...
    protected $prodotti_composizione = array();
    /**
    ...
    public  function addProdottiComposizione($prodotti=array()) {
        $this->prodotti_composizione = $prodotti;
    }
    /**
     * Aggiunge un prodotto correlato
     * @param ProdottoAbstract $prodotto
     */
    public function addProdottoComposizione(ProdottoAbstract $prodotto){
        $this->prodotti_composizione[] = $prodotto;
    }
    
    public function getProdottiComposizione(){
        return $this->prodotti_composizione;
    }
    
    public function getProdottoComposizione($index){
        return $this->prodotti_composizione[$index];;
    }
    /**
