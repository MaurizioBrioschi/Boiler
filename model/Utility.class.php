...
namespace ridesoft\Boiler\model;
  ...
  class Utility {
    ...
    public static function getStato($field){
		if(strcmp($field,"1")==0)	return "Attivo";
...
public static function curPageURL() {
 ...
 public static function getDeviceType()  {
            ...
            if( $iphone || $ipad || $blackberry || $android)    {
                $browser = "mobile_";
                if($iphone) return $browser."iphone";
                if($ipad) return $browser."ipad";
                if($blackberry) return $browser."blackberry";
